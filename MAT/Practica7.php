<html>
    ...
    <body bgcolor="#f0f0f0">
        <table>
         ...
         <center>
             <form method="post" action="Practica7.php">
        ...
        <?php
        $Resp = isset($_POST['Resp']) ? $_POST['Resp'] : -1;
        // en este caso el parentesis si es potencia, 
     //Formula; an = 2(n+1) - 2
     // sucesion a imprimir; 0,2,6,14,30,62...
        ...
        while ($i <= $n){
         ...
         echo'<table>
            ...
            echo'<form method="post" action="Practica7.php">';
